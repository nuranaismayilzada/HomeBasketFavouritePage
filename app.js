...
function createElement(apiDatas, page) {
    let card = document.createElement("div");
    card.className = "card";
    card.style.border = "1px solid grey";
    card.style.width = "360px"
    card.style.border = "none";
    card.style.height = "408px";
    ...
    let title = document.createElement("p")
    title.innerText = apiDatas.title;
    title.className = "title";
    title.style.fontSize = "16px";
    title.style.fontWeight = "900";
    ...
    let price = document.createElement("span")
    price.innerText = apiDatas.price + " AZN";
    price.className = "price";
    price.style.fontSize = "20px";
    price.style.fontWeight = "900";
    price.style.color = "red";
    ...
    let discount = document.createElement("span")
    discount.innerText = parseInt((+apiDatas.price) + 50) + " AZN";
    discount.className = "price";
    discount.style.fontSize = "20px";
    discount.style.fontWeight = "900";
    discount.style.color = "#4CC3FF";
    ...
    card.append(newBtn, basketIcon, favIcon, image, title, star, discount, price)
    page.append(card)

}

// function basketPageProductCreate(apiDatas) {
//     let box = document.createElement("div");
//     box.className = "card";
//     box.style.border = "1px solid grey";
//     box.style.width = "360px"
//     box.style.border = "none";
//     box.style.height = "408px";
//     box.style.borderRadius = "20px";
//     box.style.backgroundColor = "#F9F9F9";
...
//     pilusBtn.innerText = "+";
//     pilusBtn.className = "pilus";
//     pilusBtn.style.width = "40px";
//     pilusBtn.style.height = "30px";
//     pilusBtn.style.textAlign = "center";
//     pilusBtn.style.fontSize = "30px";
...
//     let btns = document.createElement("div")
//     btns.className = "btns";
//     pilusBtn.style.width = "100px";

//     btns.append(pilusBtn, minusBtn)
//     box.append(newBtn, favIcon, image, title, star, discount, price, btns)
...
// let salasm=document.querySelector(".fa-cart-shopping").addEventListener("click",()=>{
//     window.open("http://127.0.0.1:5500/basket.html")
// })